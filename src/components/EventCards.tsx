...
export default function EventCards(card: eventCard) {
  return (
    <>
      <div className="w-1/2 relative min-w-[10rem] bg-[#2c6bff] h-[12rem] min-h-max p-2  rounded-md shadow-xl">
        <div
          className={`absolute w-[5rem] h-full  flex items-center rounded-full  top-0 ${
            card.index % 2 === 1 ? "left-0" : "right-0"
          }`}
        >
          {/* <div
            className={`w-[2rem] h-[2rem] bg-blue border-[0.3rem] border-white shadow-2xl rounded-full ${
